                ...
                {<div className='ml-auto flex invisible group-hover/document-item:visible' onClick={(e) => e.stopPropagation()}>
                    <Popover>
                        ...
                        <PopoverContent className="m-0 p-0 w-56 translate-x-30 bg-accent">
                            <h1 className="flex items-center p-2 cursor-pointer hover:bg-background" onClick={(e) => pageDeleteHandler(e, id)}>
                    ...
                    <Plus className='mr-3 size-4' onClick={(e) => childPageHandler(e, id)} />
                </div>}
            </div>
